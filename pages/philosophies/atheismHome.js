    ...
    <div className="App">
      ...
      <div className="MainContentContainer">
        ...
        <p>Atheism is the belief that there is no supreme God, and many atheists also believe that there is
            ...
            that nobody knows, you should visit the main <Link href="./agnosticismHome"><a className ='articleLinks'>Agnosticism</a></Link> article.
        </p>
        <p>
        ...
        <div className="iframeVideo">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/BdLIX3vZGK8" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
        <br/>
        <p>
