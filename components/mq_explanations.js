...
export function infinite_regress(){
    return(
        <div>
            ...
            <p>Right now, all I have proved is that an entity which is outside of time and space exists. You may have already thought ahead and drawn other conclusions from that information. If you have, I suggest <Link href="/articles/comparing_religions" className='articleLinks'><a>Comparing Religions</a></Link>. If you have not, allow me to recommend the following.</p>
            <div>
